    ...
    const moduleRef = await Test.createTestingModule({
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: {
            listByCategory: async (cv: string, cat: string) => [
              {
                id: '1',
        ...
        },
        {
          ...
          useValue: {
            getTeamMeta: async () => ({ companyId: 'company-1', active: true }),
          },
        },
        {
          provide: TOKENS.TaxonomyQuery,
          useValue: { requiredSkillsForCategory: async () => [] },
        },
        // Use-cases
        {
          provide: GrantTeamZone,
          useFactory: (zones, cq, cat, tq) =>
            new GrantTeamZone(zones, cq, cat, tq),
          inject: [
        ...
        },
        {
          ...
          useFactory: (zones, cq, cat, tq) =>
            new RevokeTeamZone(zones, cq, cat, tq),
          inject: [
            TOKENS.TeamZoneRepository,
            TOKENS.ContractQuery,
            TOKENS.CatalogQuery,
        ...
        },
        {
          ...
          useFactory: (skills, cq, tq) => new GrantTeamSkill(skills, cq, tq),
          inject: [
        ...
        },
        {
          ...
          useFactory: (skills, cq, tq) => new RevokeTeamSkill(skills, cq, tq),
          inject: [
            TOKENS.TeamSkillRepository,
            TOKENS.ContractQuery,
            TOKENS.TeamQuery,
        ...
        },
        {
          ...
          useFactory: (m, tx, ts, cq, cat, tq) =>
            new UpsertCompetency(m, tx, ts, cq, cat, tq),
          inject: [
        ...
        },
        {
          ...
          useFactory: (m, cq, cat, tq) => new RemoveCompetency(m, cq, cat, tq),
          inject: [
            TOKENS.CompetencyMatrixRepository,
            TOKENS.ContractQuery,
            TOKENS.CatalogQuery,
        ...
        },
        {
          ...
          useFactory: (m, z, s, t, tx) =>
            new ResolveEligibleTeams(m, z, s, t, tx),
          inject: [
            TOKENS.CompetencyMatrixRepository,
            TOKENS.TeamZoneRepository,
            TOKENS.TeamSkillRepository,
